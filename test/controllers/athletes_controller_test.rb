...
class AthletesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create athlete" do
    assert_difference('Athlete.count') do
      post athletes_url, params: { athlete: { age: @athlete.age, coach_id: @athlete.coach_id, email: @athlete.email, name: @athlete.name, program_id: @athlete.program_id } }
    end
  ...
  test "should update athlete" do
    patch athlete_url(@athlete), params: { athlete: { age: @athlete.age, coach_id: @athlete.coach_id, email: @athlete.email, name: @athlete.name, program_id: @athlete.program_id } }
