...
class CoachesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coach" do
    assert_difference('Coach.count') do
      post coaches_url, params: { coach: { bio: @coach.bio, email: @coach.email, name: @coach.name } }
    end
  ...
  test "should update coach" do
    patch coach_url(@coach), params: { coach: { bio: @coach.bio, email: @coach.email, name: @coach.name } }
